/*global sntls, nsntls, module, test, ok, equal, strictEqual, deepEqual, raises, expect */
(function () {
    "use strict";
    ...
    test("Type conversion", function () {
        ...
        ok(collection.isA(nsntls.JournalingCollection), "Hash converted to journaling collection");
    });
    ...
    test("Array conversion", function () {
        ...
        ok(hash.isA(nsntls.JournalingCollection), "Is journaling collecton");
        strictEqual(hash.items, buffer, "Same buffer");
    });

    test("Logging", function () {
        var collection = nsntls.JournalingCollection.create();
        ...
        nsntls.JournalingCollection.addMocks({
            resetLog: function () {
        ...
        nsntls.JournalingCollection.removeMocks();
    });

    test("Specified journ. collection", function () {
        var Specified = nsntls.JournalingCollection.of(String),
