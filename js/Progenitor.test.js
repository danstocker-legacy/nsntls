/*global phil, dessert, troop, sntls, nsntls, module, test, expect, ok, equal, notEqual, strictEqual, deepEqual, raises */
(function () {
    "use strict";
    ...
    test("Instantiation", function () {
        var instance = nsntls.Progenitor.create();
    ...
    test("Lineage registration", function () {
        ...
        ok(instance.lineages.getFirstValue().isA(nsntls.Lineage), "Lineage added");
    ...
    test("Lineage getter", function () {
        ...
        ok(lineage.isA(nsntls.Lineage), "Lineage fetched");
    ...
    test("Parent getter", function () {
        var parent = nsntls.Progenitor.create()
                .addToLineage('foo'),
            child = nsntls.Progenitor.create()
    ...
    test("Children getter", function () {
        var parent = nsntls.Progenitor.create()
                .addToLineage('foo')
                .addToLineage('bar'),
            child1 = nsntls.Progenitor.create()
                .addToLineage('foo', parent),
            child2 = nsntls.Progenitor.create()
                .addToLineage('bar', parent),
            child3 = nsntls.Progenitor.create()
                .addToLineage('bar', parent),
            expected;
    ...
    test("Adding instance to lineage", function () {
        ...
        var myParent = nsntls.Progenitor.create()
                .registerLineage('foo'),
            myChild = nsntls.Progenitor.create();

        nsntls.Lineage.addMocks({
    ...
    test("Child addition", function () {
        ...
        ok(parent.getLineage().isA(nsntls.Lineage));
        ok(child.getLineage().isA(nsntls.Lineage));
    });
    ...
    test("Child manipulation integration", function () {
        var parent1 = nsntls.Progenitor.create()
                .addToLineage('foo'),
            parent2 = nsntls.Progenitor.create()
                .addToLineage('foo'),
            child1 = nsntls.Progenitor.create()
            ...
            child3 = nsntls.Progenitor.create()
                .addToLineage('foo', parent1),
            grandchild1 = nsntls.Progenitor.create()
                .addToLineage('foo', child1),
            grandchild2 = nsntls.Progenitor.create()
                .addToLineage('foo', child1),
