...
(function () {
    ...
    test("Instantiation", function () {
        raises(function () {
            nsntls.Lineage.create(111, instance);
        }, "Invalid lineage name");

        raises(function () {
            nsntls.Lineage.create('foo', 'invalid');
        }, "Invalid instance");

        var instance = sntls.Documented.create(),
            lineage = /** @type nsntls.Lineage */ nsntls.Lineage.create('foo', instance);
    ...
    test("Collecting descendants", function () {
        var ancestor = nsntls.Progenitor.create()
                .addToLineage('foo'),
